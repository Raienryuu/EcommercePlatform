...
public class OrdersControllerTests : AppStartup
{

  public OrdersControllerTests(AppFactory app) : base(app) { }
  ...
  {
	var dbContext = _app.Services.CreateScope().ServiceProvider
